module.exports = {
    ...
    FREE_FEATURES: [
        "Analyze up to 2 properties at a time",
        "Analysis modes:",
    ...
    ELITE_FEATURES: ["Everything in Pro tier forever, plus...",
        ...
        '->Scrape unlimited listings from Zillow',
        '->Export listings to directly to Google Sheets',
        '->No code or technical knowledge needed',
